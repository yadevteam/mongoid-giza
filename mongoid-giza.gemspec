...
Gem::Specification.new do |spec|
  ...
  spec.add_development_dependency "bundler", ">= 2.2.33", "< 3.0"
  ...
  spec.add_runtime_dependency "riddle", ">= 1.5.11", "< 2.0"
  spec.add_runtime_dependency "builder", ">= 3.0", "< 4.0"
  spec.add_runtime_dependency "docile", ">= 1.1", "< 2.0"
